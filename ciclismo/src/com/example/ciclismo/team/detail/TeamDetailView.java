...
public class TeamDetailView extends DetailView implements I_TeamDetailView {

    @Override
    public int getDetailLayout() {
        return R.layout.team_detail_view;
    }

    public I_TeamDetailPresenter getDetailPresenter() {
        return (I_TeamDetailPresenter) getScreenPresenter();
    }
